...
<h1>Planos <a href="{{ route('plans.create')}}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Adicionar</a></h1>    
@stop
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('details.plan.index', $plan->url) }}" class="btn btn-primary"><i class="fas fa-info"></i> </a>
                            ...
                            <a href="{{ route('plans.profiles', $plan->id) }}" class="btn btn-warning"><i class="fas fa-list-ul"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
