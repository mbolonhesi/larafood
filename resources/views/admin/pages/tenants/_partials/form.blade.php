...
<div class="form-group">
    ...
    <select name="sbuscription_active" class="form-control">
        <option value="1" @if (isset($tenant) && $tenant->sbuscription_active == 'Y') selected @endif>Sim</option>
        <option value="0" @if (isset($tenant) && $tenant->sbuscription_active == 'N') selected @endif>Não</option>
    </select>
</div>
<div class="form-group">
