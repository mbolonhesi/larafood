...
<h1>Mesas <a href="{{ route('tables.create')}}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Adicionar</a></h1>    
@stop
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                           
                            <a href="{{ route('tables.edit', $table->id) }}" class="btn btn-info"><i class="far fa-edit"></i></a>
