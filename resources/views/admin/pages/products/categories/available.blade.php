...
@section('title', "Categorias disponíveis para produto {$product->name}")
...
<h1>Categorias disponíveis para produto <b>{{$product->name}}</b>    
@stop
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-condensed">
                ...
                <tbody>
                    <form action="{{ route('products.categories.attach',$product->id) }}" class="form" method="POST">
                        @csrf
